...
This exercise has me implement a pattern that I did in the last exercise on accident >.< during the extra credit. I used context to specify which components could have access to implicit state shared from a parent. This allows me to share state into nested components.
