...
In this exercise I practiced how to allow users to manage state reducers with inversion of control. The pattern allows the reducer to provide their own reducer. In the extra credit I practiced how to use partial default reducer, and the last extra credit taught me how to make the experience better by defining the allowable types and then the user can have access to that through the exports.
